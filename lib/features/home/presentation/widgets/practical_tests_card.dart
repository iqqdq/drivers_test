...
class PracticalTestsCard extends StatelessWidget {
  final int passed;
  final int total;
  final VoidCallback onTap;

  const PracticalTestsCard({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return Material(
      ...
      child: InkWell(
        ...
        onTap: onTap,
        child: Container(
          padding: EdgeInsets.symmetric(horizontal: 6.0, vertical: 32.0),
          height: 300.0,
          ...
          child: Column(
            children: [
              ...
              // Expanded(
              //   child: Image.asset(
              //     AppImages.cardPracticalTests, // TODO REPLACE IMAGE
